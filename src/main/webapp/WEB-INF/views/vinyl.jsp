        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="vinyl">
              <span data-feather="layers"></span>
              Vinyl<span class="sr-only">(current)</span>
            </a>
          </li>
        </ul>
        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <c:if test="${order.status ne 'COMPLETE' }">
            	<c:if test="${order.div1 eq 'VIN' || order.div2 eq 'VIN' || order.div3 eq 'VIN'}">
            	<c:if test="${order.priority eq 'HIGH'}">
            		<tr>
          			...
          			<c:if test="${order.priority eq 'LOW'}">
          				...
          				<td>
          					<c:choose>
          						<c:when test="${role eq 'ADMIN' || division eq 'VIN' }">
