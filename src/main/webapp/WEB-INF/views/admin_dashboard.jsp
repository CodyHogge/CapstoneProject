								...
								<c:if test="${order.status ne 'COMPLETE' }">
									<c:if test="${order.priority eq 'HIGH'}">
										<tr>
											...
											<td>${order.div1},<c:if test="${order.div2 ne null}">${order.div2}, </c:if>
											...
											<!-- <a class="btn btn-warning" href="#" data-toggle="modal" data-target="#addOrderNote" title="View Log">
								...
								<c:if test="${order.status ne 'COMPLETE' }">
									<c:if test="${order.status eq 'NEW'}">
										<tr>
											...
											<a class="btn btn-success" href="acceptOrder?orderId=${order.orderId}" onclick="confirmed(); return false;" title="Accept Order">
					...
					<div class="table-responsive">
						<table class="table table-striped table-sm">
							...
							<tbody>
								<c:forEach var="order" items="${orderList}">
								<c:if test="${order.status ne 'COMPLETE' }">
									<c:if test="${order.div1 eq 'EMB' or order.div2 eq 'EMB' or order.div3 eq 'EMB'}">
										<tr>
											<td><a href="orderPage?orderId=${order.orderId}">${order.orderId}</a></td>
											<td>${order.div1},<c:if test="${order.div2 ne null}">${order.div2}, </c:if>
												<c:if test="${order.div3 ne null}">${order.div3}</c:if>
											...
											<td>${order.updatedDate} by <span class="text-info"><strong>
														${order.userId}</strong></span></td>
											<td>
												<form method="POST" action="editOrderStatus">
													<input type="hidden" name="orderId"
														value="${order.orderId}" /> <select
					...
					<div class="table-responsive">
						<table class="table table-striped table-sm">
							...
							<tbody>
								<c:forEach var="order" items="${orderList}">
								<c:if test="${order.status ne 'COMPLETE' }">
									<c:if test="${order.div1 eq 'LAS' or order.div2 eq 'LAS' or order.div3 eq 'LAS'}">
										<tr>
											<td><a href="orderPage?orderId=${order.orderId}">${order.orderId}</a></td>
											<td>${order.div1},<c:if test="${order.div2 ne null}">${order.div2}, </c:if>
												<c:if test="${order.div3 ne null}">${order.div3}</c:if>
					...
					<div class="table-responsive">
						<table class="table table-striped table-sm">
							...
							<tbody>
								<c:forEach var="order" items="${orderList}">
								<c:if test="${order.status ne 'COMPLETE' }">
									<c:if test="${order.div1 eq 'SCR' or order.div2 eq 'SCR' or order.div3 eq 'SCR'}">
										<tr>
											<td><a href="orderPage?orderId=${order.orderId}">${order.orderId}</a></td>
											<td>${order.div1},<c:if test="${order.div2 ne null}">${order.div2}, </c:if>
												<c:if test="${order.div3 ne null}">${order.div3}</c:if>
					...
					<div class="table-responsive">
						<table class="table table-striped table-sm">
							...
							<tbody>
								<c:forEach var="order" items="${orderList}">
								<c:if test="${order.status ne 'COMPLETE' }">
									<c:if test="${order.div1 eq 'VIN' or order.div2 eq 'VIN' or order.div3 eq 'VIN'}">
										<tr>
											<td><a href="orderPage?orderId=${order.orderId}">${order.orderId}</a></td>
											<td>${order.div1},<c:if test="${order.div2 ne null}">${order.div2}, </c:if>
												<c:if test="${order.div3 ne null}">${order.div3}</c:if>
