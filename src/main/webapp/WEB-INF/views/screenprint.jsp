...
<c:set var="page" value="Screenprint"/>
<!DOCTYPE html>
<html>
<head>
<meta charset="ISO-8859-1">
<title>Screenprint Dashboard</title>
  <!-- Custom CSS -->
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="screenprint">
              <span data-feather="layers"></span>
              Screen Print<span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item">
        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <c:if test="${order.status ne 'COMPLETE' }">
            	<c:if test="${order.div1 eq 'SCR' || order.div2 eq 'SCR' || order.div3 eq 'SCR'}">
            	<c:if test="${order.priority eq 'HIGH'}">
            		<tr>
          			...
          			<c:if test="${order.priority eq 'LOW'}">
          				...
          				<td>
          					<c:choose>
          						<c:when test="${role eq 'ADMIN' || division eq 'SCR' }">
